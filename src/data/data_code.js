...
export const FILES = [
  {
    ...
    commits: [{ msg: "Sube umbral de match a 0.82", hash: "a1f9c2", by: "AR", when: "12m" }, { msg: "Añade bloqueo por IBAN", hash: "7d3e10", by: "MC", when: "2d" }],
  ...
  },
  {
    ...
    commits: [{ msg: "Normaliza divisa a USD", hash: "44ab90", by: "AR", when: "1d" }],
  ...
  },
  {
    ...
    commits: [{ msg: "Cuenta gaps > 60min", hash: "9c12fa", by: "JD", when: "5h" }],
    last: { by: "JD", when: "5h", hash: "9c12fa" },
  },
  {
    id: "pipe", path: "pipeline.yml", lang: "yaml", builds: null, inputs: [], node: null,
    code: "version: 1\npipeline: blackfrost\nschedule: \"*/5 * * * *\"\nstages:\n  - normalize_txn\n  - entity_resolution\n  - ais_rollup\n",
    commits: [{ msg: "Cadencia a 5 min", hash: "01ffae", by: "AR", when: "2d" }],
